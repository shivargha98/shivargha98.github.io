export const projects = [
  {
    ...
    kind: 'Agentic AI',
    oneLiner:
      'Ask a database questions in plain English. A LangGraph agent generates SQL, guards it, self-corrects, and charts the answer.',
    ...
    stack: [
      ...
      'Gemini 2.0 Flash, local Qwen 2.5 (Ollama), and Groq Llama 3.1 for multi-model routing',
